...
col_selected <- c('priority_veteran__c','O2O_Program_Participant__c','VCTP_Participant__c','Active_Color__c','Gender__c','Race__c','Job_Type__c','Used_Volunteer_Services__c','On_Job_Board__c','Created_LinkedIn_account__c','Highest_Level_of_Education_Completed__c','Service_Branch__c','Service_Rank__c')
